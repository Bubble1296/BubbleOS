...
Available commands:
 ...
 update          - Displays information about what has been updated
""")
...
# About the OS:
        ...
        print(
            """A simple OS simulator written in Python.
Currently a work-in-progress.
It can create, read, write, and delete text files."""
            )
# About the update(s):
        ...
        print(
        """BubbleOS build v0.2:
        - Added a more descriptive text about what BubbleOS can currently do.
        - Added the "update" screen."""
              )
