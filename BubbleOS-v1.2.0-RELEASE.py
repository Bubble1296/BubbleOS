...
def open_browser():
    ...
    make_draggable(browser_win) # <-- Added Draggable
...
def open_files_app():
    ...
    make_draggable(files_window) # <-- Added Draggable

    # Storage path
    storage_path = os.path.expanduser("~/Documents/BubbleOS_Files") 
...
def open_word_processor():
    ...
    make_draggable(word_win) # <-- Added Draggable
    ...
    tk.Button(toolbar, text="Close", command=word_win.destroy).pack(side="left", padx=5) # Fixed btn_frame to toolbar
...
def open_calculator():
    ...
    make_draggable(calc_win) # <-- Added Draggable
...
def open_settings_app():
    ...
    make_draggable(settings_win) # <-- Added Draggable
...
def open_games_app():
    ...
    make_draggable(game_win) # <-- Added Draggable
...
def open_cli_app():
    ...
    make_draggable(cli_win) # <-- Added Draggable
...
def open_uptime_app():
    ...
    make_draggable(uptime_win) # <-- Added Draggable
